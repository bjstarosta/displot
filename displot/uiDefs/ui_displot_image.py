...
class Ui_ImageTabPrototype(object):
    def setupUi(self, ImageTabPrototype):
        ...
        self.imageToolsScrollArea.setGeometry(QtCore.QRect(0, 0, 260, 454))
        ...
        self.fragmentList.horizontalHeader().setDefaultSectionSize(60)
    ...
    def retranslateUi(self, ImageTabPrototype):
        ...
        item.setText(_translate("ImageTabPrototype", "pos:X"))
        item = self.fragmentList.horizontalHeaderItem(1)
        item.setText(_translate("ImageTabPrototype", "pos:Y"))
