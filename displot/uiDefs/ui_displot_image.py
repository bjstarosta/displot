...
class Ui_ImageTabPrototype(object):
    def setupUi(self, ImageTabPrototype):
        ...
        self.imageToolsScrollArea.setGeometry(QtCore.QRect(0, -220, 260, 471))
    ...
    def retranslateUi(self, ImageTabPrototype):
        ...
        self.value_AnglesCompared.setToolTip(_translate("ImageTabPrototype", "The script will attempt to compare each flagged area from a number of angles. This number dictates how many angles will be generated, i.e. how many slices Pi should be split up into."))
