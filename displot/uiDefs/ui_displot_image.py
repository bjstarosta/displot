...
class Ui_ImageTabPrototype(object):
    def setupUi(self, ImageTabPrototype):
        ...
        self.imageTools.setGeometry(QtCore.QRect(0, 0, 282, 296))
        ...
        self.imageToolsScrollArea.setGeometry(QtCore.QRect(0, -136, 260, 454))
        ...
        self.labelledItems.setGeometry(QtCore.QRect(0, 0, 282, 296))
        ...
        self.fragmentList = QtWidgets.QTableWidget(self.labelledItems)
        ...
        self.fragmentList.setColumnCount(4)
        self.fragmentList.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.fragmentList.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.fragmentList.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.fragmentList.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.fragmentList.setHorizontalHeaderItem(3, item)
        self.fragmentList.horizontalHeader().setCascadingSectionResizes(False)
        self.fragmentList.horizontalHeader().setDefaultSectionSize(50)
        ...
        self.btnFindDisl.setMaximumSize(QtCore.QSize(50, 16777215))
    ...
    def retranslateUi(self, ImageTabPrototype):
        ...
        item = self.fragmentList.horizontalHeaderItem(0)
        item.setText(_translate("ImageTabPrototype", "#"))
        item = self.fragmentList.horizontalHeaderItem(1)
        item.setText(_translate("ImageTabPrototype", "x"))
        item = self.fragmentList.horizontalHeaderItem(2)
        item.setText(_translate("ImageTabPrototype", "y"))
        item = self.fragmentList.horizontalHeaderItem(3)
        item.setText(_translate("ImageTabPrototype", " "))
...
from ui_widgets import MinimapView, WorkImageView
