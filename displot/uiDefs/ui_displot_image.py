...
class Ui_ImageTabPrototype(object):
    ...
    def retranslateUi(self, ImageTabPrototype):
        ...
        self.button_AddFrag.setText(_translate("ImageTabPrototype", "Add"))
        self.button_RemFrag.setText(_translate("ImageTabPrototype", "Rem"))
        self.button_MovFrag.setText(_translate("ImageTabPrototype", "Mov"))
