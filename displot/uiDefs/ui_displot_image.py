...
class Ui_ImageTabPrototype(object):
    def setupUi(self, ImageTabPrototype):
        ...
        self.imageToolsScrollArea.setGeometry(QtCore.QRect(0, -177, 260, 428))
        ...
        self.value_GaussianSigma.setProperty("value", 1.65)
        ...
        self.value_DiscardMargins.setProperty("value", 10)
        ...
        self.value_DiscardLabels.setProperty("value", 5)
        ...
        self.value_DissimilarityTolerance.setProperty("value", 2.0)
        ...
        self.value_DissimilarityTarget.setProperty("value", 20.0)
        ...
        self.value_CorrelationTolerance.setProperty("value", 0.1)
    ...
    def retranslateUi(self, ImageTabPrototype):
        ...
        self.label_GaussianSigma.setText(_translate("ImageTabPrototype", "Gaussian sigma\n"
"(increase for less edges)"))
        ...
        self.label_DiscardMargins.setText(_translate("ImageTabPrototype", "Discard fragments within pixels of image margin"))
