...
class Ui_ImageTabPrototype(object):
    def setupUi(self, ImageTabPrototype):
        ...
        self.button_Discrimination = QtWidgets.QPushButton(self.imageTools)
        self.button_Discrimination.setObjectName("button_Discrimination")
        self.verticalLayout_2.addWidget(self.button_Discrimination)
        self.button_RemoveHidden = QtWidgets.QPushButton(self.imageTools)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/feathericons/3rdparty/feather/icons/alert-triangle.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_RemoveHidden.setIcon(icon)
        self.button_RemoveHidden.setObjectName("button_RemoveHidden")
        self.verticalLayout_2.addWidget(self.button_RemoveHidden)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/feathericons/3rdparty/feather/icons/map-pin.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/feathericons/3rdparty/feather/icons/check-square.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_SelectAllFrags.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/feathericons/3rdparty/feather/icons/plus-square.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_AddFrag.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/feathericons/3rdparty/feather/icons/minus-square.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_RemFrag.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/feathericons/3rdparty/feather/icons/move.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_MovFrag.setIcon(icon5)
    ...
    def retranslateUi(self, ImageTabPrototype):
        ...
        self.button_Discrimination.setToolTip(_translate("ImageTabPrototype", "Will set all features not matching the discrimination parameters\n"
"as hidden in the interface."))
        self.button_Discrimination.setText(_translate("ImageTabPrototype", "Apply discrimination"))
        self.button_RemoveHidden.setToolTip(_translate("ImageTabPrototype", "Will remove all hidden features from the feature list. This is irreversible."))
        self.button_RemoveHidden.setText(_translate("ImageTabPrototype", "Remove all hidden features"))
