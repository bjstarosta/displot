...
class Ui_ImageTabPrototype(object):
    def setupUi(self, ImageTabPrototype):
        ...
        self.button_ClusterDetect = QtWidgets.QPushButton(self.imageTools)
        self.button_ClusterDetect.setObjectName("button_ClusterDetect")
        self.verticalLayout_2.addWidget(self.button_ClusterDetect)
        ...
        self.imageToolsScrollArea.setGeometry(QtCore.QRect(0, 0, 241, 392))
        ...
        self.formLayout = QtWidgets.QFormLayout(self.imageToolsScrollArea)
        self.formLayout.setObjectName("formLayout")
        self.value_ScanMethod = QtWidgets.QComboBox(self.imageToolsScrollArea)
        self.value_ScanMethod.setObjectName("value_ScanMethod")
        self.value_ScanMethod.addItem("")
        self.value_ScanMethod.addItem("")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.SpanningRole, self.value_ScanMethod)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.SpanningRole, self.label_step1)
        self.label_FGMedian = QtWidgets.QLabel(self.imageToolsScrollArea)
        self.label_FGMedian.setObjectName("label_FGMedian")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_FGMedian)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.value_FGMedian)
        self.label_BGMedian = QtWidgets.QLabel(self.imageToolsScrollArea)
        self.label_BGMedian.setObjectName("label_BGMedian")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_BGMedian)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.value_BGMedian)
        ...
        self.label_DetailSkew.setMinimumSize(QtCore.QSize(0, 50))
        self.label_DetailSkew.setScaledContents(False)
        self.label_DetailSkew.setWordWrap(True)
        self.label_DetailSkew.setObjectName("label_DetailSkew")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.label_DetailSkew)
        ...
        self.value_DetailSkew.setMinimumSize(QtCore.QSize(0, 0))
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.value_DetailSkew)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.SpanningRole, self.label_step2)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.label_MinFeatureArea)
        ...
        self.value_MinFeatureArea.setMinimumSize(QtCore.QSize(0, 0))
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.value_MinFeatureArea)
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.label_MaxBboxOverlap)
        ...
        self.value_MaxBboxOverlap.setMinimumSize(QtCore.QSize(0, 0))
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.value_MaxBboxOverlap)
        self.label_MaxOverlap = QtWidgets.QLabel(self.imageToolsScrollArea)
        self.label_MaxOverlap.setMinimumSize(QtCore.QSize(0, 35))
        self.label_MaxOverlap.setWordWrap(True)
        self.label_MaxOverlap.setObjectName("label_MaxOverlap")
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.label_MaxOverlap)
        ...
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.value_MaxOverlap)
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.SpanningRole, self.label_step3)
        self.label_Centroids = QtWidgets.QLabel(self.imageToolsScrollArea)
        self.label_Centroids.setObjectName("label_Centroids")
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.LabelRole, self.label_Centroids)
        self.value_Centroids = QtWidgets.QSpinBox(self.imageToolsScrollArea)
        self.value_Centroids.setObjectName("value_Centroids")
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.value_Centroids)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/feathericons/vendor/feather/icons/map-pin.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/feathericons/vendor/feather/icons/plus-square.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_AddFrag.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/feathericons/vendor/feather/icons/minus-square.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_RemFrag.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/feathericons/vendor/feather/icons/move.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_MovFrag.setIcon(icon3)
    ...
    def retranslateUi(self, ImageTabPrototype):
        ...
        self.button_ClusterDetect.setText(_translate("ImageTabPrototype", "Detect clusters"))
        self.value_ScanMethod.setItemText(0, _translate("ImageTabPrototype", "Method: Wavelet Detail Analysis"))
        self.value_ScanMethod.setItemText(1, _translate("ImageTabPrototype", "Method: Background Separation"))
        self.label_step1.setText(_translate("ImageTabPrototype", "<html><head/><body><p><span style=\" font-weight:600;\">Settings:</span> Feature selection</p></body></html>"))
        ...
        self.label_step2.setText(_translate("ImageTabPrototype", "<html><head/><body><p><span style=\" font-weight:600;\">Settings:</span> Discrimination</p></body></html>"))
        ...
        self.label_step3.setText(_translate("ImageTabPrototype", "<html><head/><body><p><span style=\" font-weight:600;\">Settings:</span> Cluster detection</p></body></html>"))
        self.label_Centroids.setText(_translate("ImageTabPrototype", "Expected clusters"))
